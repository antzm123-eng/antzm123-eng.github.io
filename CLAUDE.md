...
- "어린이한테 설명하듯" 쉬운 비유를 곁들일 것. 표·숫자 선호, 긴 산문 비선호
...
⚠️ **크기만 재고 끝내지 말 것.** 실제로 눌러보고 **눈으로도 볼 것** — 숫자는 맞는데 사진이
누워 있던 적이 있다(함정 14번). 버그 3건을 그렇게 놓쳤다.
...
작업·갤러리 66개(사진 33·디자인 33) / 사진 315장.
...
- "운영"은 `공간 운영` 처럼 범위 한정 · **검증 불가능한 수치는 넣지 말 것**
